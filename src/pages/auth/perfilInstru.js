            ...
            <nav className="navbar navbar-expand-lg nnnn">
                <div className="container-fluid">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <Link to="/instructor" className="nav-link">Cronograma</Link>
                        </li>
                        <li class="nav-item">
                            <Link to="#" className="nav-link">Hola Instructor</Link>
                        </li>
                    </ul>
                    <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li><Link className="dropdown-item" to="/perfilInstru">Perfil</Link></li>
