...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else if (rol === 2) navigate('/coordinador');
      else if (rol === 3) navigate('/profesional');
      else if (rol === 4) navigate('/instructor');
      else setError('No se pudo identificar el rol.');
    } catch (error) {
